module.exports = function (grunt) {
    grunt.registerTask('bump_version', function (version) {
        ...
        grunt.config('string-replace.MarkdownDeep-js', {
            files: {'src/js/MarkdownDeep.js': 'src/js/MarkdownDeep.js'},
            options: {
                replacements: [
                    {
                        pattern: /\/*! version : .*/,
        ...
        grunt.config('string-replace.MarkdownDeep-css', {
            files: { 'src/less/MarkdownDeep.less': 'src/less/MarkdownDeep.less' },
            options: {
                replacements: [
                    {
                        pattern:     / * version : .*/,
        ...
        grunt.task.run([
            'string-replace:MarkdownDeep-js',
            'string-replace:MarkdownDeep-css',
